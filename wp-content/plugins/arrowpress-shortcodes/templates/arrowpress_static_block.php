    ...
    if ($posts->have_posts()) {
        ...
        if (class_exists('Ultimate_VC_Addons')) {
            ...
            if($ultimate_css == "enable"){
                ...
                //if( stripos( $post_content, '[ultimate_carousel') ) {
                //  wp_enqueue_style("ult-slick", $arrowpress_ult_assets . 'slick/slick.css');
                //  wp_enqueue_style("ult-icons", $arrowpress_ult_assets . 'slick/icons.css');
                //}
            } else {
                ...
                if( stripos( $post_content, '[ultimate_carousel') ) {
                    wp_enqueue_style("ult-slick", $arrowpress_ult_assets . 'slick/slick.css');
                    wp_enqueue_style("ult-icons", $arrowpress_ult_assets . 'slick/icons.css');
                    wp_enqueue_style("ult-slick-animate", $arrowpress_ult_assets . 'slick/animate.min.css');
