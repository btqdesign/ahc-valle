				...
				?>	
				    <?php if (class_exists('WP_Hotel_Booking')):?>	    
			        	<?php if(isset($solaz_settings['header_book_text']) && $solaz_settings['header_book_text'] !=''):?>
			        		...
			        		<div class="link-contact f_right main-bg display-inline-b">
			        			<?php if ($language == 'es'):?>	
								<a class="" target="_blank" href="https://secure.internetpower.com.mx/portals/ValleDeMexico/Hotel/HotelDescription.aspx?CheckIn=20181201&CheckOut=20181202&PropertyNumber=6422&Provider=0&Rooms=1&AccessCode=WEBPAGE&Currency=MXN">Reservar Ahora</a>
								<?php else:?>
								<a class="" target="_blank" href="https://secure.internetpower.com.mx/portals/ValleDeMexico/Hotel/HotelDescription.aspx?CheckIn=20181201&CheckOut=20181202&PropertyNumber=6422&Provider=0">Book Now</a>
								</a>	
